...
public final class FeRequest extends Table {
  ...
  public String experimentType() { int o = __offset(14); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer experimentTypeAsByteBuffer() { return __vector_as_bytebuffer(14, 1); }
  public int interval() { int o = __offset(16); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  ...
  public static int createFeRequest(FlatBufferBuilder builder,
      ...
      int ebIdOffset,
      int experimentTypeOffset,
      int interval) {
    builder.startObject(7);
    FeRequest.addInterval(builder, interval);
    FeRequest.addExperimentType(builder, experimentTypeOffset);
  ...
  public static void startFeRequest(FlatBufferBuilder builder) { builder.startObject(7); }
  ...
  public static void addExperimentType(FlatBufferBuilder builder, int experimentTypeOffset) { builder.addOffset(5, experimentTypeOffset, 0); }
  public static void addInterval(FlatBufferBuilder builder, int interval) { builder.addInt(6, interval, 0); }
